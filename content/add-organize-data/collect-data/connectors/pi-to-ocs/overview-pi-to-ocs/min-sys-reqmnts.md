...
| PI to OCS Agent | <ul><li> Install on a different computer than your PI Data Archive deployment.</li><li>Use a domain account on a machine that is registered to the same domain.<br>**Note:** Windows Active Directory (AD) is required.</li> |
