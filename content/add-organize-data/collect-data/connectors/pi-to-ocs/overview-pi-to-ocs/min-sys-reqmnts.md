...
| PI to OCS Agent | <ul><li><p>Install on a different computer than your PI Server deployment.</p></li><li><p>Use a domain account on a machine registered to the same domain.</p><p><strong>Note:</strong> Windows Active Directory (AD) is required.</p></li></ul> |
