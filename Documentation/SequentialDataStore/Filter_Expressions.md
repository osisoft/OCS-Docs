...
Filter expressions can be applied to certain read operations that return Sequential Data Store values or objects. This section covers data values. For filtering on Sds objects refer to [Filter Expressions: Objects](xref:sdsFilterExpressionsMetadata).
